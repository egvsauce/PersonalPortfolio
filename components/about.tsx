    ...
    >
      ...
      <div className="mt-8 grid gap-10 md:grid-cols-2 md:items-start">
        ...
        <div className="space-y-6 text-left">
          <p className="text-gray-800 dark:text-gray-100 leading-relaxed bg-white/50 dark:bg-white/5 rounded-xl p-5 ring-1 ring-black/5 dark:ring-white/10">
            Hello! I’m{" "}
            <span className="font-semibold">Ethan Vasquez</span>, a Computer
            Science student and software engineer focused on building clean,
            performant interfaces and reliable backends. I have hands-on
            experience with{" "}
          ...
          <p className="text-gray-800 dark:text-gray-200 leading-relaxed">
            I love shipping features end-to-end, from accessible components and
            design systems to API design and deployment. Recently I’ve been
            exploring{" "}
            <span className="font-medium">Next.js + Tailwind</span>,{" "}
            <span className="font-medium">ASP.NET Core</span>, and data-driven
            UI patterns. Outside of code, you’ll find me refining product polish
            and collaborating on teams where thoughtful details matter.
          </p>
        </div>
      </div>
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2">
        {/* Education Card */}
        <div className="rounded-3xl bg-[#1F2040] text-gray-200 p-8 shadow-md border border-white/10">
        ...
        {/* Skills Card */}
        <div className="rounded-3xl bg-[#26285A] text-gray-200 p-8 shadow-md border border-white/10">
          <h3 className="flex items-center gap-3 text-xl font-semibold mb-4">
            <span className="text-pink-400">💻</span>
            Skills
          </h3>
